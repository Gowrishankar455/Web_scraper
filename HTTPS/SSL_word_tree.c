...
//Struct tree to store word and frequency
    struct tree
    {
	  char *word;
	  int count;
...
//Function to allocate memory for the word
   char *mstrdup(char *s)       
   {
          char *p;
...
//Function to create a word in the tree
...
//Function to add a word to tree
...
//Functions to rank the words based on their frequency
...
//Function to rank words based on their frequency
   void ranker()                           
   {
